                  ...
                  Expanded(
                    child: Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeDefault),
                      ...
                      child: ListView(physics: const BouncingScrollPhysics(), children: [
                        ...
                        CustomTextFieldWidget(
                          isEnabled: config?.customerVerification?.email == 0 || profile.userInfoModel?.emailVerifiedAt == null,
                        ...
                        CustomTextFieldWidget(
                          isEnabled: config?.customerVerification?.phone == 0 || profile.userInfoModel?.isPhoneVerified == 0,
