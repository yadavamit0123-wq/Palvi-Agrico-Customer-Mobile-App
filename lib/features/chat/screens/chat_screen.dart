    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: Theme.of(context).cardColor,
        ...
        leading: InkWell(onTap: ()=> Navigator.pop(context),
          ...
          title: Row(
            children: [
              ClipRRect(borderRadius: BorderRadius.circular(Dimensions.radiusHundred),
                child: SizedBox(height: Dimensions.paddingSizeButton, width: Dimensions.paddingSizeButton,
