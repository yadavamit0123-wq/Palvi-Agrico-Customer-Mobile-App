                      ...
                      child: CustomButton(leftIcon: Images.dollarIcon,
                        ...
                        onTap: (){
                          ...
                          if (point <= 0) {
                            ...
                            showCustomSnackBarWidget(getTranslated('point_must_be_positive', context), context, snackBarType: SnackBarType.warning);
                          } else if (point < min!) {
                            Navigator.pop(context);
                            showCustomSnackBarWidget('${getTranslated('minimum_point_is', context)} $min', context, snackBarType: SnackBarType.warning);
