                        ...
                        Positioned(top: 0, right: 0,
                         ...
                         Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Flexible(
                                child: Text('${productController.findWhatYouNeedModel!.findWhatYouNeed![index].name}',
                                  style: textRegular.copyWith(color: Theme.of(context).primaryColor,
                                   fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600, overflow: TextOverflow.ellipsis),
                                  maxLines: 1,
                                ),
                              ),
