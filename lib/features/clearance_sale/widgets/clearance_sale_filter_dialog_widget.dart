                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            (categoryProvider.selectedCategoryIds.isNotEmpty || brandProvider.selectedBrandIds.isNotEmpty
                              ...
                              onTap: () async {
                                ...
                                if(!widget.fromShop) {
                                  Provider.of<ProductController>(Get.context!, listen: false).getClearanceSearchProduct(offset: 1, query: Provider.of<ProductController>(Get.context!, listen: false).searchText ?? '');
                                }
                              },
                              child: Row(children: [
                                SizedBox(width: 20, child: Image.asset(Images.reset)),
