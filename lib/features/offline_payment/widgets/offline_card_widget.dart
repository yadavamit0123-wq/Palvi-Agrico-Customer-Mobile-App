...
class OfflineCardWidget extends StatelessWidget {
  ...
  const OfflineCardWidget({super.key, required this.offlinePaymentModel, required this.index, this.selectedIndex});
    ...
    return Consumer<CheckoutController>(
        builder: (context, orderProvider, _) {
          return Stack(children: [
            ...
            Padding(padding: const EdgeInsets.fromLTRB(0, Dimensions.paddingSizeDefault, Dimensions.paddingSizeDefault,
              ...
              child: Container(width: MediaQuery.of(context).size.width *.75, height: 180,
                decoration: BoxDecoration(
                  color: index == (selectedIndex ?? orderProvider.offlineMethodSelectedIndex) ? Theme.of(context).cardColor :
                  Theme.of(context).primaryColor.withValues(alpha:.125),
                  border: index == (selectedIndex ?? orderProvider.offlineMethodSelectedIndex) ?
            ...
            if(index == (selectedIndex ?? orderProvider.offlineMethodSelectedIndex))
